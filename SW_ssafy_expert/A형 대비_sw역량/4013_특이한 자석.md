...
public class Solution{
    ...
    static void rotate(int row, int wise){      // 톱니바퀴를 회전시키는 함수.
        if(wise == -1){      // 시계방향 <-
            int tmp = arr[row][0];
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int t = 1; t <= T; t++) {
            ...
            for(int i = 0 ; i < K; i++){
                ...
                boolean[] check = new boolean[3];   // 톱니바퀴가 맞닿은 곳의 양극이 같은지 다른지 체크하는 배열.
                for(int c = 0; c < 3; c++){     //서로 극이 다른 부분 체크하기.
                    if(arr[c][2] != arr[c+1][6]) check[c] = true;   // 극이 다르다면 true;
                }   
